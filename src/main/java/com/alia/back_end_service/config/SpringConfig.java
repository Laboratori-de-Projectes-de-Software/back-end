...
public class SpringConfig {
    ...
    @Bean
    public LoginUserUseCase loginUserUseCase(UserPortDB userPortDB, PasswordEncoderPort passwordEncoderPort) {
        return new LoginUserUseCase(userPortDB, passwordEncoderPort);
    }
}
