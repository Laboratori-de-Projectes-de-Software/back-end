...
public class JwtProvider {
    ...
    public String generateToken(Map<String, Object> claims, UserSecurityAdapter usuario) {
        return buildToken(claims,usuario,jwtExpiration);
    }

    private String buildToken(Map<String, Object> claims, UserSecurityAdapter usuario, long expirationTime) {
        return Jwts
                .builder()
                .setClaims(claims)
    ...
    public boolean isTokenValid(String token, UserSecurityAdapter usuario) {
